...
var _bootstrapMinJsDefault = parcelHelpers.interopDefault(_bootstrapMinJs);
    ...
    entries.forEach((entry)=>{
        if (entry.isIntersecting) {
            ...
            if (mediaQuery.matches) {
                ...
                entry.target.id === link.textContent ? link.classList.add("hover-class") : link.classList.remove("hover-class");
            });
        }
    });
};
...
const popoverList = [
    ...popoverTriggerList
].map((popoverTriggerEl)=>new (0, _bootstrapMinJsDefault.default).Popover(popoverTriggerEl));
...
if (mediaQuery.matches) {
    ...
    document.body.addEventListener("click", function(e) {
        if (!e.target.closest("#navbarId") && menu.classList.contains("show")) jq(".navbar-collapse").collapse("toggle");
    });
...
},{"bootstrap/dist/js/bootstrap.min.js":"boekP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"boekP":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hIFAM","6rimH"], "6rimH", "parcelRequire2041")
